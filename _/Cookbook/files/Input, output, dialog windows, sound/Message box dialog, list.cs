/// To quickly insert code for <see cref="dialog.show"/> and other <see cref="dialog"/> functions, use snippet dsDialogShowSnippet: in the code editor type ds and select from the list.
