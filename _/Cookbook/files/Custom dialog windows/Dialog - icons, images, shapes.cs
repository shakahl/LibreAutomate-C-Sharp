...
/// - <see cref="wpfBuilder.Image"/>. This recipe provides an example. Note: if screen DPI is not 100%, WPF scales non-XAML images and they are a little blurry; there is no easy way to prevent it.
