...
/// To get values from a JSON string without converting it to an object, use class <see cref="JsonNode"/>. See recipe "Http POST...". The class also can be used to create a JSON string. Look for more info on the internet.

/// JSON is a good format for various settings. The <see cref="JSettings"/> class uses it. See recipe "Saving variables".
