...
///
/// To add a trigger, use menu TT -> Window triggers. It opens a script where you can add and edit triggers. You'll find more info and examples there; also in file Readme.txt.
///
