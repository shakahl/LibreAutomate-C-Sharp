...
/// Then in the code editor type the variable name and dot (.), and select a function from the list. If need help, click the function name in the code editor and press F1.
