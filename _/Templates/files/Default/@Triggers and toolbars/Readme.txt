...
There are several examples. Enable them and run the script to see how it works.
...
To disable a trigger, comment out the trigger code line. Then click Run to restart.
To disable/enable all triggers, use the tray icon (menu or middle-click) or menu TT.
Also you can comment out the [Triggers] attribute to disable all triggers defined there.
See also examples in class ActionTriggers help.

Avoid multiple scripts with triggers running all the time. It makes your computer slower.

Also you can create menus. They are like toolbars, but displayed temporarily and therefore
