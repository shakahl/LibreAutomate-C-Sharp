...
class CiCompletion
{
	...
	public string GetDescriptionXaml(CiComplItem ci, int iSelect) {
		...
		if (symbols != null)
			return CiXaml.FromSymbols(symbols, iSelect, _data.model, _data.tempRange.CurrentFrom,
				o => _popupList.PopupXaml.Xaml = GetDescriptionXaml(ci, o.ToInt()));
