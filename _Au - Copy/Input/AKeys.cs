...
namespace Au
{
	...
	/// </summary>
	/// <remarks>
	/// The main function is <see cref="Key"/>. Most documentation is there. See also <see cref="Text"/>. These functions use <see cref="AOpt.Key"/>. Alternatively can be used <b>AKeys</b> variables, see <see cref="AKeys(OptKey)"/>.
	/// </remarks>
	/// <example>
	/// <code><![CDATA[
	...
	public partial class AKeys
	{
		...
		/// ]]></code>
		/// </example>
		public AKeys(OptKey cloneOptions) { Options = new OptKey(cloneOptions); }
