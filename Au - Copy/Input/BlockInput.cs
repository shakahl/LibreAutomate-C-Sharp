...
namespace Au
{
	...
	/// <item>In windows of higher [](xref:uac) integrity level (IL) processes, unless this process has uiAccess IL.</item>
	/// <item>In special desktops/screens, such as when you press Ctrl+Alt+Delete or launch an admin program that requires UAC elevation. See also <see cref="ResumeAfterCtrlAltDelete"/>.</item>
