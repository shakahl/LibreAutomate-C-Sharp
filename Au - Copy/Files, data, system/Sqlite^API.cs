...
namespace Au.Types
{
	...
	/// <summary>
	/// Flags for <see cref="SqliteDB"/> constructor.
	/// </summary>
	[Flags]
	public enum SLFlags
	{
...
#pragma warning restore CS1591
	...
	internal static unsafe class SLApi
	{
		...
		internal static string Errmsg(IntPtr db) => Convert_.Utf8ToString(sqlite3_errmsg(db));
		...
		internal static string Errstr(SLError r) => Convert_.Utf8ToString(sqlite3_errstr(r));
