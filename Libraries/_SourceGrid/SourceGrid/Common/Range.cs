...
namespace SourceGrid
{
	...
	public struct GridRange
	{
		...
		public GridRange(Position p_Start, Position p_End):this(p_Start, p_End, true)
		{
		}
		
		public static GridRange FromPosition(Position startPosition)
		{
			return new GridRange(startPosition);
		}

		
		public static GridRange From(Position startPosition, int rowCount, int colCount)
		{
			var range = new GridRange(startPosition);
		...
		public GridRange(int p_StartRow, int p_StartCol, int p_EndRow, int p_EndCol)
		{
		...
		private GridRange(Position p_Start, Position p_End, bool p_bCheck)
		{
			m_Start = p_Start;
			m_End = p_End;
		...
		static GridRange()
		{
			Empty = new GridRange(Position.Empty, Position.Empty, false);
		}
		...
		public GridRange(Position p_SinglePosition):this(p_SinglePosition, p_SinglePosition, false)
		{
		}
		...
		/// </summary>
		public readonly static GridRange Empty;
		...
		/// <returns></returns>
		public bool Contains(GridRange p_Range)
		{
		...
		/// <param name="p_Range"></param>
		/// <returns></returns>
		public bool Equals(GridRange p_Range)
		{
		...
		/// <returns></returns>
		public static RangeRegion Union(GridRange p_Range1, GridRange p_Range2)
		{
		...
		/// <param name="p_Range"></param>
		/// <returns></returns>
		public GridRange Intersect(GridRange p_Range)
		{
		...
		/// <param name="p_Range2"></param>
		/// <returns></returns>
		public static bool IntersectsWith(GridRange p_Range1, GridRange p_Range2)
		{
		...
		/// <param name="p_Range"></param>
		/// <returns></returns>
		public bool IntersectsWith(GridRange p_Range)
		{
	...
	public interface IRangeLoader
	{
		...
		/// </summary>
		GridRange GetRange(GridVirtual p_grid);
	}
	...
	public class RangeFullGrid : IRangeLoader 
	{
		...
		/// <returns></returns>
		public GridRange GetRange(GridVirtual p_Grid)
		{
	...
	public class RangeFullGridNoFixedRows : IRangeLoader 
	{
		...
		public GridRange GetRange(GridVirtual p_Grid)
		{
			if (p_Grid.Rows.Count>=p_Grid.FixedRows)
				return new GridRange(p_Grid.FixedRows,0,p_Grid.Rows.Count-1,p_Grid.Columns.Count-1);
			else
				return GridRange.Empty;
		}
	}
	...
	public class RangeFullGridNoFixedCols : IRangeLoader 
	{
		...
		public GridRange GetRange(GridVirtual p_Grid)
		{
			if (p_Grid.Columns.Count >= p_Grid.FixedColumns)
				return new GridRange(0,p_Grid.FixedColumns,p_Grid.Rows.Count-1, p_Grid.Columns.Count-1);
			else
				return GridRange.Empty;
		}
	}
	...
	public class RangeFixedRows : IRangeLoader 
	{
		...
		{
			if (p_Grid.Rows.Count>=p_Grid.FixedRows)
				return new GridRange(0,0,p_Grid.FixedRows,p_Grid.Columns.Count-1);
			else
				return GridRange.Empty;
		}
	}
	...
	public class RangeFixedCols : IRangeLoader 
	{
		...
		{
			if (p_Grid.Columns.Count >= p_Grid.FixedColumns)
				return new GridRange(0, 0, p_Grid.Rows.Count-1, p_Grid.FixedColumns);
			else
				return GridRange.Empty;
		}
	}
	...
	{
		private GridRange mRange;
		/// <summary>
		/// Constructor
		/// </summary>
		public RangeLoader(GridRange range)
		{
			mRange = range;
		}
		...
		/// <param name="p_Grid"></param>
		/// <returns></returns>
		public virtual GridRange GetRange(GridVirtual p_Grid)
		{
			return mRange;
		}
	}
