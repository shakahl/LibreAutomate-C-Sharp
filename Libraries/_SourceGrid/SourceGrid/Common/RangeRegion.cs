...
namespace SourceGrid
{
	...
	/// </summary>
	[Serializable]
	public class RangeRegion : ICollection<GridRange>
	{
		#region Constructors
		public RangeRegion()
		{
		...
		public RangeRegion(Position position)
		{
			if (position.IsEmpty() == false)
				m_RangeCollection.Add(new GridRange(position));
		}
		public RangeRegion(GridRange range)
		{
		...
		/// <returns></returns>
		public GridRange this[int index]
		{
		...
		public virtual int[] GetRowsIndex()
		{
			...
			foreach (GridRange range in this)
			{
		...
		/// <returns></returns>
		public virtual bool Contains(GridRange p_Range)
		{
		...
		/// <param name="p_Range"></param>
		/// <returns></returns>
		public virtual bool IntersectsWith(GridRange p_Range)
		{
			if (p_Range.IsEmpty() || IsEmpty())
				return false;
		...
		/// <param name="p_Range"></param>
		/// <returns></returns>
		public virtual RangeRegion Intersect(GridRange p_Range)
		{
			...
			if (p_Range.IsEmpty() == false && IsEmpty() == false)
			{
				...
				for (int i = 0; i < m_RangeCollection.Count; i++)
				{
					GridRange intersectRange = p_Range.Intersect(m_RangeCollection[i]);
		...
		public RangeRegion Intersect(RangeRegion pRange)
		{
			...
			{
				GridRange rangeToCheck = pRange.m_RangeCollection[rToCheck];
		...
		/// <returns></returns>
		public RangeRegion Exclude(GridRange pRange)
		{
			RangeRegion range = new RangeRegion();
		...
		public void Clear(GridRange pRangeToLeave)
		{
		...
		{
			return Add(new GridRange(pCell));
		}
		...
		{
			return Remove(new GridRange(pCell));
		}
		...
		/// <param name="pRange"></param>
		/// <returns>Returns true if sucesfully added</returns>
		public bool Add(GridRange pRange)
		{
		...
		/// <param name="pRange"></param>
		/// <returns>Returns true if sucesfully removed</returns>
		public bool Remove(GridRange pRange)
		{
		...
		private bool InternalAdd(RangeRegion pRange)
		{
			...
			else
			{
				...
				{
					GridRange rangeToAdd = pRange.m_RangeCollection[rToAdd];
		...
		#region ICollection<GridRange> Members
		void ICollection<GridRange>.Add(GridRange item)
		{
			this.Add(item);
		}

		public void CopyTo(GridRange[] array, int arrayIndex)
		{
		...
		#region IEnumerable<GridRange> Members
