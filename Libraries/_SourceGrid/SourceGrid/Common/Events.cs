...
//	}
	...
	public class RangePaintEventArgs : EventArgs
	{
		...
		private GridRange mDrawingRange;
		public GridRange DrawingRange
		{
	...
	{
		private GridRange m_GridRange;
		public RangeEventArgs(GridRange p_GridRange)
		{
	...
	{
		public SelectionChangeEventArgs(SelectionChangeEventType p_Type, GridRange p_Range)
		{
			m_Type = p_Type;
			m_Range = p_Range;
		}
	...
	public class SortRangeRowsEventArgs : EventArgs
	{
		...
		public SortRangeRowsEventArgs(GridRange p_Range,
		                              int keyColumn,
		                              bool p_bAscending,
