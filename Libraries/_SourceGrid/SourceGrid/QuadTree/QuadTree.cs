...
namespace QuadTreeLib
{
	...
	public class QuadTree
	{
		...
		/// </summary>
		public List<GridRange> Contents {
			get 
			{ 
		...
		public QuadTree(int rows, int columns)
			:this(new GridRange(1, 1, rows, columns))
		{
		}
		...
		public QuadTree(GridRange rectangle)
		{
		...
		public QuadTree Insert(GridRange item)
		{
			m_root.Insert(item);
			return this;
		}
		
		public QuadTree Remove(GridRange range)
		{
			m_root.Remove(range);
			return this;
		}
		...
		/// Insert the feature into the QuadTree
		/// </summary>
		public QuadTree Insert(IEnumerable<GridRange> items)
		{
		...
		public List<GridRange> Query(Position area)
		{
			return m_root.Query(area);
		}
		...
		/// <param name="area"></param>
		/// <returns></returns>
		public GridRange? QueryFirst(Position area)
		{
			return m_root.QueryFirst(area);
		}
		
		public GridRange? QueryFirst(GridRange area)
		{
			return m_root.QueryFirst(area);
		}
