...
namespace QuadTreeLib
{
	...
	public class QuadTreeNode
	{
		...
		public QuadTreeNode(GridRange bounds)
		{
		...
		/// </summary>
		List<GridRange> m_contents = new List<GridRange>();
		...
		/// </summary>
		public GridRange Bounds { get { return m_bounds; } }
		...
		/// </summary>
		public List<GridRange> SubTreeContents
		{
			get
			{
		...
		public List<GridRange> Contents { get { return m_contents; } }

		
		public List<GridRange> Query(GridRange queryArea)
		{
		...
		public List<GridRange> Query(Position queryArea)
		{
			// create a list of the items that are found
			List<GridRange> results = new List<GridRange>();
		...
		public GridRange? QueryFirst(Position queryArea)
		{
			// this quad contains items that are not entirely contained by
			// it's four sub-quads. Iterate through the items in this quad
			// to see if they intersect.
