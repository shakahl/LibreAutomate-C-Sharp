...
namespace SourceGrid.Cells.Controllers
{
	...
	public class SortableHeader : ControllerBase
	{
		...
		public void SortColumn(CellContext sender, bool p_bAscending, System.Collections.IComparer p_Comparer )
		{
			...
			{
				GridRange l_RangeToSort;
				GridRange l_RangeHeader;
				if (m_RangeToSort != null)
					...
					l_RangeToSort = new GridRange(sender.Position.Row+1, 0, sender.Grid.Rows.Count - 1, sender.Grid.Columns.Count - 1);
				...
				if (m_HeaderRange != null)
					...
					l_RangeHeader = new GridRange(0, 0, sender.Position.Row, sender.Grid.Columns.Count - 1);
