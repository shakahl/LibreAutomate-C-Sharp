...
namespace SourceGrid
{
	...
	public struct CellContext
	{
		...
		/// <summary>
		/// Calculate the GridRange occupied by the current cell. Usually it is simply the Position property, only if RowSpan or ColumnSpan is used this property returns a larger range.
		/// Internally use the Grid.PositionToCellRange method.
		/// </summary>
		public GridRange CellRange
		{
			get
			{
