...
namespace SourceGrid.Exporter
{
	...
	public class GridPrintDocument : PrintDocument
	{
		...
		private GridRange m_RangeToPrint = GridRange.Empty;

		public GridRange RangeToPrint {
		...
		protected override void OnBeginPrint(PrintEventArgs e)
		{
			...
			if (RangeToPrint.IsEmpty())
				RangeToPrint = new GridRange(0, 0, m_Grid.Rows.Count - 1, m_Grid.Columns.Count - 1);
