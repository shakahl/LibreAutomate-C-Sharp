...
namespace SourceGrid.Selection
{
	...
	public abstract class SelectionBase : IGridSelection
	{
		...
		{
			foreach (GridRange rng in GetSelectionRegion())
		...
		/// </summary>
		public abstract bool IsSelectedRange(GridRange range);
		/// <summary>
		/// Select or unselect the specified range
		/// </summary>
		/// <param name="range"></param>
		/// <param name="select"></param>
		public abstract void SelectRange(GridRange range, bool select);
		...
		/// <returns></returns>
		public abstract bool IntersectsWith(GridRange rng);
		...
		/// <param name="rng"></param>
		/// <returns></returns>
		protected GridRange ValidateRange(GridRange rng)
		{
		...
		protected virtual void OnSelectionChanged(RangeRegionChangedEventArgs e)
		{
			...
			{
				foreach (GridRange r in e.AddedRange)
					Grid.InvalidateRange(r);
			}

			if (e.RemovedRange != null)
			{
				foreach (GridRange r in e.RemovedRange)
					Grid.InvalidateRange(r);
			}
		}
		#endregion
