...
namespace Aga.Controls.Tree
{
	...
	{
		Other, //other event, eg SelectedNode=n; selected 1
		LeftClick, //left-clicked; selected 1
		RightClick, //right-clicked; selected 1
		Key, //key Up/Down/etc; selected 1
		Multi, //selected >1, or selected 1 but was selected >1 (Ctrl+click a selected)
		NoSelection, //selected 0
	}
