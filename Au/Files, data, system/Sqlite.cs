...
namespace Au
{
	...
	public unsafe class SqliteDB : IDisposable
	{
		...
		public static implicit operator IntPtr(SqliteDB c) => c._db;
		...
		/// Read about SQL parameters in SQLite website. Supported types: <see cref="SqliteStatement.BindAll"/>. Example: <see cref="SqliteDB"/>.
		/// </param>
		...
		/// See <see cref="SLTransaction(SqliteDB, string, string)"/>.
		/// </summary>
	...
	public unsafe class SqliteStatement : IDisposable
	{
		...
		/// <exception cref="SLException">Failed.</exception>
		/// <exception cref="NotSupportedException">sql contains more than single SQL statement.</exception>
		public SqliteStatement(SqliteDB db, string sql, bool persistent = false)
		{
		...
		/// <param name="values">
		/// Values that will replace ? characters in sql.
		/// Read about SQL parameters in SQLite website. Example: <see cref="SqliteDB"/>.
		/// Supported types:
...
namespace Au.Types
{
	...
	public struct SLTransaction : IDisposable
	{
		...
		/// <exception cref="SLException">Failed to execute sql.</exception>
		public SLTransaction(SqliteDB db, string sql = "BEGIN", string sqlOfDispose = "ROLLBACK") : this()
		{
...
#pragma warning restore CS1591
	...
	internal static unsafe class SLUtil
	{
		...
		//currently not used
		//internal static void Err(SLError r, SqliteDB db, string func)
		//{
