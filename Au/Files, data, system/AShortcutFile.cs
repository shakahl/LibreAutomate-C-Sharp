...
namespace Au
{
	...
	public unsafe sealed class AShortcutFile : IDisposable
	{
		...
		/// <summary>
		/// Creates a new <see cref="AShortcutFile"/> instance that can be used to create or replace a shortcut file.
		...
		/// <summary>
		/// Creates a new <see cref="AShortcutFile"/> instance that can be used to create or modify a shortcut file.
