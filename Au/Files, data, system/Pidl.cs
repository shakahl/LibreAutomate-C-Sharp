...
namespace Au
{
	...
	public unsafe sealed class Pidl : IDisposable
	{
		...
		/// </summary>
		/// <remarks>
		/// The string can be used with some functions of this library, mostly of classes <b>Exec</b>, <b>Pidl</b> and <b>AIcon</b>. Cannot be used with native and .NET functions.
		/// </remarks>
