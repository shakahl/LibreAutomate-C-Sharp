...
namespace Au
{
	...
	/// </summary>
	/// <remarks>
	/// For return values is used type <see cref="AFolderPath"/>, not string. It is implicitly convertible to string. Its operator + appends a filename or relative path string, with \ separator if need. Example: <c>string s = Folders.Desktop + "file.txt"; //C:\Users\Name\Desktop\file.txt</c>
	...
	public static class Folders
	{
		...
		//DON'T: The + operator returns AFolderPath. Then Folders.Desktop + subfolder + file would return "desktop\subfolder\file". Probably not good.
	}
}
