...
namespace Au.Util
{
	...
	public static class AStringUtil
	{
		...
		/// <summary>
		/// Converts array of command line arguments to string that can be passed to a "start process" function, for example <see cref="ARun.Run"/>, <see cref="Process.Start"/>.
