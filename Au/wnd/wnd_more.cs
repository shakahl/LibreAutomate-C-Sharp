...
#pragma warning restore CS1573 // Parameter has no matching param tag in the XML comment (but other parameters do)
			...
			///// To get class atom when you have a window w, use <c>wnd.more.getClassLong(w, GCL.ATOM)</c>.
			///// </summary>
			///// <param name="className">Class name.</param>
...
{
	/// <summary>
	/// Options for <see cref="wnd.more.printMsg"/>.
	/// </summary>
	...
	/// <summary>
	/// <see cref="wnd.more.dragLoop"/> callback function arguments.
	/// </summary>
	...
	/// <summary>
	/// Used with <see cref="wnd.more.registerWindowClass"/>.
	/// </summary>
	[NoDoc]
	public class RWCEtc
	{
