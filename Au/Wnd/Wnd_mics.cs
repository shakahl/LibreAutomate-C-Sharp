...
namespace Au
{
	public partial struct Wnd
	{
		...
		public static partial class Misc
		{
			...
			/// <summary>
			/// Calls API <msdn>ChangeWindowMessageFilter</msdn> to enable receiving WM_COPYDATA message from lower <see cref="Process_.UacInfo">UAC</see> integrity level processes, for example if you'll use <see cref="InterProcessGetData"/>.
