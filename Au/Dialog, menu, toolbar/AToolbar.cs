...
namespace Au
{
	...
	/// TODO
	/// </summary>
	internal class AToolbar : AMTBase //now internal because unfinished
	{
		static AToolbar()
		{
		...
		/// <param name="icon">See <see cref="AMenu.Add(string, Action{MTClickArgs}, object)"/>.</param>
		/// <remarks>
		...
		class ToolStrip_ : ToolStrip, _IAuToolStrip
		{
			...
			internal ToolStrip_(AToolbar parent) { _parent = parent; }
