...
namespace Au
{
	...
	public class Osd :OsdWindow
	{
		...
		/// </remarks>
		public static Osd ShowText(string text,
		...
		/// </remarks>
		public static Osd ShowTransparentText(string text,
			int secondsTimeout = 0, PopupXY xy = null,
		...
		/// </remarks>
		public static Osd ShowImage(Image image,
			int secondsTimeout = 0, PopupXY xy = null,
			string name = null, OsdShowMode showMode = default, bool doNotShow = false)
		{
			var o = new Osd();
		...
		/// <summary>Default border color for <see cref="ShowText"/> and <b>Osd</b>. Default: 0xFF404040 (dark gray).</summary>
		public static ColorInt DefaultBorderColor { get; set; } = 0xFF404040;

		/// <summary>Default background color for <see cref="ShowText"/> and <b>Osd</b>. Default: 0xFFFFFFF0 (light yellow).</summary>
...
{
	/// <summary>
	/// Whether <see cref="Osd.Show"/> waits or shows the OSD window in this or new thread.
	/// </summary>
	/// <remarks>
	...
	public enum OsdShowMode
	{
		...
		/// Waits <see cref="Osd.SecondsTimeout"/> seconds. While waiting, dispatches messages etc; see <see cref="Time.SleepDoEvents"/>.
		/// </summary>
		Wait,
	}
}