...
namespace Au
{
	...
	/// </summary>
	/// <remarks>
	/// The Dbg.PrintX functions write to the same output as <see cref="Output.Write"/>, not to the trace listeners like <see cref="Debug.Print(string)"/> etc do. Also they add caller's name, file and line number.
	...
	{
		/// <summary>
		/// Prefix for Dbg.Print, Dbg.PrintIf.
		/// Default is "Debug: ".
		/// </summary>
		/// <example>
		/// Blue text.
		/// <code><![CDATA[
		/// Dbg.TextPrefix = "<><c 0xff0000>"; Dbg.TextSuffix = "</c>";
		/// ]]></code>
		/// </example>
		...
		/// <summary>
		/// Suffix for Dbg.Print, Dbg.PrintIf.
		/// </summary>
		...
		///// <summary>
		///// If Opt.Debug.<see cref="OptDebug.Verbose"/> == true, calls <see cref="AuDialog.Show"/> with text and stack trace.
