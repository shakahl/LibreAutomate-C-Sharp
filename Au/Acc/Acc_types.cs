...
namespace Au.Types
{
	...
	public enum AFFlags
	{
		...
		/// Even without this flag, the default search method is not used with Windows Store app windows, console windows, most Java windows, windows of protected processes and processes of higher <see cref="Process_.UacInfo">UAC</see> integrity level, Firefox web page if its multiprocess feature is not disabled.
