...
Disconnect
InternetSetStatusCallback(m_hitop &Ftp_Callback)
str pw.decrypt(16 password "86dbos00~'@n")
out m_hitop
InternetConnectW(m_hitop @server iif(port port INTERNET_DEFAULT_FTP_PORT) @username @pw INTERNET_SERVICE_FTP iif(flags&1 INTERNET_FLAG_PASSIVE 0) &this)
