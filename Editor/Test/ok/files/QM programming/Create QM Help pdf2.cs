 ...
 This macro is for me. It is almost exact copy of "Crete QM Help pdf", which is for forum. Just wkhtmltopdfDir is different, and may be more debug code.

 1. Run this macro.
 2. Zip the pdf and upload as attachment in http://www.quickmacros.com/forum/viewtopic.php?f=2&t=5133.
    To fix server bug, also add a small txt file to the zip, eg with info such as the download URL.
...
str wkhtmltopdfDir="$qm$\pdf\wkhtmltopdf"

 _________________________________________________________________

 out
 clo "Foxit Reader"; err ;;<debug>
...
QMPDF_GetHtmlFiles htmlDir cl aFiles 1
 cl+ F" ''{htmlDir}\QM_Help\IDH_TRIG_COMMANDLINE.html'' ''{htmlDir}\User\IDP_QMDLL.html''" ;;<debug>
