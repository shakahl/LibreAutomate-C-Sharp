...
simp :"paste text" ;;same as above, but uses clipboard instead of keys. If 'Hybrid paste' checked in Options, uses keys for short text, clipboard for long or multiline text.
