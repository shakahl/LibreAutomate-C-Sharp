 /
function# $items [$text] [$caption] [flags] [hwndOwner] [x] [y] [timeoutS] [default] [`icons] [cbFunc] [cbParam] ;;items: "item1[]item2[]...".    flags: 1 don't activate, 2 item IDs, 4 image indices, 8 wider, 16 fixed height, 32 32x32 icons, 64 raw x y, 128 mouse x y.
...
type ___LD41_CB $s r ii
type ___LD42_CB flags timeout default ARRAY(___LD41_CB)a iSel BSTR'dispB dispI il cbFunc cbParam
___LD42_CB z.flags=flags; z.timeout=timeoutS; z.default=default
