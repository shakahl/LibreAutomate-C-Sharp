...
str controls = "0 3"
str d0 e3
d0=F"dialog_LSB_{OsdId}"
e3=trigger

clo win(d0 "#32770"); err ;;kill existing dialog

type LSB_DATA color size ;;define type to pass more info to the dialog procedure
LSB_DATA z; z.color=color; z.size=size ;;create and set variable of that type
...
if(!ShowDialog("dialog_LSB" &dialog_LSB &controls 0 0 0 0 &z x y)) ret
