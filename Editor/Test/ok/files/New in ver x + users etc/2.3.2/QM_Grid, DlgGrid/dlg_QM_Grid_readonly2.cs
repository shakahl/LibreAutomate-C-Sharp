...
if(!ShowDialog("" &dlg_QM_Grid_readonly2 0 _hwndqm)) ret
...
sel message
	case WM_INITDIALOG
	g=id(3 hDlg)
	 SendMessage g LVM_QG_SETSTYLE QG_NOEDIT -1
	SendMessage g LVM_QG_SETSTYLE QG_NOEDIT|QG_NOAUTOADD -1
	 add columns
	lpstr columns="one[]two[]three"
