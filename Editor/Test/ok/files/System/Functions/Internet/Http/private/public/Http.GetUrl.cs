function# $url str&s [flags] [inetflags] [dlg] [fa] [fparam] [str&responseheaders] ;;flags: 1-3 use cache, 16 download to file, 32 run in other thread
...
__HInternet hi=InternetOpenUrl(m_hitop url 0 0 inetflags 0); if(!hi) ret Error(1)
