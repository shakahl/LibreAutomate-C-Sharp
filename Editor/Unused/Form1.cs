...
namespace Editor
{
	public partial class Form1 :Form
	{
...
#if TV_NATIVE
			_tv = _tvPane.Init();
			_tvWndproc = (Native.WNDPROC)Marshal.GetDelegateForFunctionPointer(_tv.GetWindowLong(Api.GWL_WNDPROC), typeof(Native.WNDPROC));
		...
		void _LoadCollection()
		{
			...
			//il.LoadFromImageFile_(Folders.ThisApp + "il_tv.png");
		...
		public class CatTreeView :TreeView
		{
			...
			protected override void OnAfterSelect(TreeViewEventArgs e)
			{
				...
				if(x.IsFolder) {
					...
					//PrintList(path, Files.FileExists(path));
			...
			protected override void OnDrawNode(DrawTreeNodeEventArgs e)
			{
				...
				if(e.Bounds.Width > 0 && e.Bounds.Height > 0) {
					...
					//PrintList(e.Node.Text, e.State, e.Bounds);
