...
partial class EForm
{
	public struct EStrips
	{
		public MenuStrip Menubar;
		public CatToolStrip File, Edit, Run, Tools, Help, Custom1, Custom2; //toolbars
		public ToolStripDropDownMenu FileNew;
		public ToolStripSpringTextBox HelpFind;
	}
	...
	void _Strips_Init()
	{
		...
		Strips.File = _strips.Toolbars["File"];
		Strips.Edit = _strips.Toolbars["Edit"];
		Strips.Run = _strips.Toolbars["Run"];
		Strips.Tools = _strips.Toolbars["Tools"];
		Strips.Help = _strips.Toolbars["Help"];
		Strips.Custom1 = _strips.Toolbars["Custom1"];
		Strips.Custom2 = _strips.Toolbars["Custom2"];

		//get submenus that will be filled later etc
		_strips.Submenus["File_Templates"].Opening += _Strips_MenuOpening_Templates;
		_strips.Submenus["File_RecentCollections"].Opening += _Strips_MenuOpening_RecentCollections;
		(Strips.FileNew = _strips.Submenus["File_New"]).Opening += _Strips_MenuOpening_New;
		...
		//get controls
		Strips.HelpFind = Strips.Help.Items["Help_Find"] as ToolStripSpringTextBox;
