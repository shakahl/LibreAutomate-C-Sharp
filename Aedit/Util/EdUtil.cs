...
static class EdResources
{
	...
	//	Aedit.Resources.Resources.Culture = System.Globalization.CultureInfo.InvariantCulture;
	//}
	...
	/// </summary>
	/// <param name="name">Resource name. Use <c>nameof(Aedit.Resources.Resources.name)</c>.</param>
	/// <remarks>
	/// Uses memory cache. Gets the same object when called multiple times for the same name. Don't dispose it.
	/// Calling Aedit.Resources.Resources.name or ResourceManager.GetObject would create object copies.
	/// Thread-safe.
	/// </remarks>
	...
	/// </summary>
	/// <param name="name">Image resource name. Use <c>nameof(Aedit.Resources.Resources.name)</c>.</param>
	...
	/// </summary>
	/// <param name="name">Resource name. Use <c>nameof(Aedit.Resources.Resources.name)</c>.</param>
	public static object GetObjectNoCache(string name) => Aedit.Resources.Resources.ResourceManager.GetObject(name, Aedit.Resources.Resources.Culture);
