...
class CiPopupList
{
	...
	public CiPopupList(CiCompletion compl, SciCode docForDpi) {
		...
		if (App.Settings.ci_complGroup) _groupButton.Checked = true;
	...
	void _GetMiscImages() {
		_imgGroup = EdResources.GetImageNoCacheDpi(nameof(Aedit.Resources.Resources.ciGroupBy), _dpi);
		_imgStatic = EdResources.GetImageNoCacheDpi(nameof(Aedit.Resources.Resources.ciOverlayStatic), _dpi);
		_imgAbstract = EdResources.GetImageNoCacheDpi(nameof(Aedit.Resources.Resources.ciOverlayAbstract), _dpi);
