...
class PanelOutput : AuUserControlBase
{
	...
	public PanelOutput()
	{
		...
		App.OutputServer.SetNotifications(_GetServerMessages, this);
	}

	void _GetServerMessages()
	{
		_c.ZTags.OutputServerProcessMessages(App.OutputServer, m => {
			...
			//(_iPanel ??= Panels.PanelManager.ZGetPanel(this)).Visible = true; //TODO
		});
	}
