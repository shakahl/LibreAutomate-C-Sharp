...
namespace Catkeys
{
	...
	public static partial class Input
	{
		...
		public static class Misc
		{
			...
			/// Valid s examples: "A", "a", "7", "F12", ".", "End", "Ctrl+D", "Ctrl+Alt+Shift+Win+Left", " Ctrl + U ".
			/// Invalid s examples: "", "A+B", "Ctrl+A+K", "A+Ctrl", "Ctrl+Shift", "Ctrl+", "NoSuchKey", "end".
			...
			static Keys _KeynameToKey(string s, int i, int len)
			{
				...
				case "Ctrl": case "Control": return Keys.ControlKey; //often called "Control", and on some rare keyboards it is "Control"
				case "Alt": return Keys.Menu;
				case "Win": case "Windows": return Keys.LWin;
				//right
				case "RShift": return Keys.RShiftKey;
				case "RCtrl": case "RControl": return Keys.RControlKey;
				...
				case "Menu": case "Application": return Keys.Apps;
				...
				case "Space": case "Spacebar": return Keys.Space;
			...
			static Dictionary<string, Keys> _CreateKeyMap()
			{
				...
				var a = new Dictionary<string, Keys>(90) { //let it be case-sensitive, because difficult to read key names like pagedown
					//Shift/Ctrl/Alt/Win, not as modifier flags
					{ "Shift", Keys.ShiftKey },
					{ "Ctrl", Keys.ControlKey }, { "Control", Keys.ControlKey }, //often called "Control", and on some rare keyboards it is "Control"
					{ "Alt", Keys.Menu },
					{ "Win", Keys.LWin }, { "Windows", Keys.LWin },
					//right
					{ "RShift", Keys.RShiftKey },
					{ "RCtrl", Keys.RControlKey }, { "RControl", Keys.RControlKey },
