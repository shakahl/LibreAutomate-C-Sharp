...
namespace Catkeys
{
	...
	public delegate void TDAsyncResult(TDResult r);
	...
	public static partial class Show
	{
		...
		/// Wraps Windows API function TaskDialogIndirect. You can find more info in MSDN.
		/// </summary>
		/// <example>
		/// <code>
		...
		public class TaskDialogObject
		{
			...
			public TDResult Show()
			{
				...
				if(_c.pszWindowTitle == null) _c.pszWindowTitle = _Title(null);
				...
				if((_c.hMainIcon == (IntPtr)TDIcon.App || _c.hFooterIcon == (IntPtr)TDIcon.App) && Resources.AppIconHandle32 != Zero)
			...
			public void ShowAsync(TDAsyncResult onClose = null)
			{
				Task.Run(() =>
				{
					Show();
			...
			public struct Sender
			{
				...
				/// Example (in an event handler): <c>ed.Obj.Send.Message(Show.TaskDialogObject.TDM_.CLICK_VERIFICATION, 1);</c>
				...
				/// Call this method while the dialog is open, eg in an event handler.
				/// Example (in an event handler): <c>ed.Obj.Send.Text(true, Show.TaskDialogObject.TDE_.CONTENT, "New text.");</c>
				/// </summary>
