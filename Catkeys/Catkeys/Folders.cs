...
namespace Catkeys
{
	...
	public static class Folders
	{
		...
		/// </summary>
		public static FolderPath Temp { get { return __Temp ?? (__Temp = Path.GetTempPath().TrimEnd('\\')); } }
		...
		/// </remarks>
		public static FolderPath ThisApp { get { return __App ?? (__App = AppDomain.CurrentDomain.BaseDirectory.TrimEnd('\\')); } }
		static string __App;

		//Differences from Application.xAppDataPath: no version, no ClickOnce support.
		static string _DefaultAppSubDir { get { return __defaultAppSubDir ?? (__defaultAppSubDir = Application.CompanyName + "\\" + Application.ProductName); } }
		...
		public static FolderPath ThisAppDataCommon
		{
			get
			{
				if(__appDataCommon == null) __appDataCommon = ProgramData + _DefaultAppSubDir;
				return __appDataCommon;
			}
			set
			{
				__appDataCommon = value;
			}
		}
		...
		/// </summary>
		public static FolderPath ThisProcess { get { return Application.StartupPath; } }
