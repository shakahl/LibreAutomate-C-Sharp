...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
		...
		public unsafe string[] ToStringArray(int maxCount = -1)
		{
			...
			string[] a1 = t_a1; //at first use the threadlocal array. When it is filled, use a2.
			List<string> a2 = null;
		...
		[ThreadStatic] static string[] t_a1 = new string[c_a1Size]; //tested: with WeakReference cannot make fast enough.
