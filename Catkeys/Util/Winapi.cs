...
{
	//Add Windows constants to enums by prefix. Eg enum WM_ { CREATE=... }. Then in code: WM_.CREATE.
	//Alternatively, add all Windows constants to the 'api' class as const. Then in code: api.WM_CREATE.
	//Alternatively, add all Windows constants to single enum, and add 'using Catkeys.Winapi.Constants;'. Then in code: WM_CREATE.
	//	Then for functions too: using static Catkeys.Winapi.Api.
	//TODO: see how others do (and pinvoke.net) most often.

	public enum WM_ :uint
	{
		/// <summary>
