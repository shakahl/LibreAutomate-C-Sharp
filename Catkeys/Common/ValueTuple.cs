//This source file is taken from https://github.com/dotnet/corefx/blob/master/src/System.ValueTuple/src/System/ValueTuple/ValueTuple.cs
//Purpose - support C# 7 tuples without the ValueTuple.dll assembly which is not included in older .NET framework versions.

using System.Collections;
using System.Collections.Generic;
using System.Diagnostics;
//using System.Numerics.Hashing; //Catkeys
...
namespace System
{
	...
	//Also there are several other modifications in other places (easier to make them there). Look for comment word Catkeys.

	static class SR
	{
		internal const string ArgumentException_ValueTupleIncorrectType = "Incorrect ValueTuple type";
		internal const string ArgumentException_ValueTupleLastArgumentNotAValueTuple = "Last argument is not a ValueTuple";
	}
