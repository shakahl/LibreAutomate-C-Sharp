...
namespace Au.Controls
{
	...
	/// 1. To set/get it use <see cref="SciTextF.AnnotationText(int, string)"/>, not direct Scintilla API.
	...
	/// </remarks>
	public unsafe class SciImagesF
	{
		class _Image
		{
		...
		internal SciImagesF(AuScintilla c, bool isEditor = false)
		{
