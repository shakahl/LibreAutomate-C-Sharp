...
namespace Au.Controls
{
	...
	public partial class InfoWindow /*: IMessageFilter*/
	{
		...
		_Window _W {
			get {
				if(_w == null || _w.IsDisposed) {
					...
					_w.Controls.Add(_c = new _Control(this, 0, InitTwoControlsSplitPos) { Name = "_c" });
					if(InitTwoControlsSplitPos > 0) _w.Controls.Add(_c2 = new _Control(this, InitTwoControlsSplitPos, InitTwoControlsSplitPos) { Name = "_c2" });
				}
				return _w;
			}
		}
		...
		/// </remarks>
		public SIZE Size {
			get => _size != default ? _size : ADpi.ScaleSize((300, 200), _w); //todo: possibly incorrect, currently not used
