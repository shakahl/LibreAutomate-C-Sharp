...
//	ITreeViewItem Parent { get; }
	...
	/// </summary>
	IEnumerable<ITreeViewItem> Items { get; }
	...
	/// <summary>
	/// Png/bmp/jpg/gif/tif or xaml image to display. Can be file path, resource with prefix "resource:", etc.
	/// Or return null and use <see cref="IconSource"/> instead.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Can be used instead of <see cref="ImageSource"/>. Path of any file, folder, etc. See <see cref="AIcon.OfFile"/>.
	/// </summary>
