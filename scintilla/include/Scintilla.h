...
//Catkeys -------------------
//#define SCI_UPDATESCROLLBARS 9501 //not impl
...
struct SCAnnotationDrawCallback
{
	int step; void* hdc; _RECT rect; const char* text; int textLen, line, annotLine;
	SCAnnotationDrawCallback() { memset(this, 0, sizeof(*this)); }
};
typedef int(__stdcall*Sci_AnnotationDrawCallback)(void* cbParam, SCAnnotationDrawCallback& c);
