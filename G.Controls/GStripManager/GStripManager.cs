...
namespace G.Controls
{
	...
	public partial class GStripManager
	{
		...
		CatToolStrip _tsCustom1, _tsCustom2; //custom toolbars
		Form _form;
		...
		public void BuildAll(string xmlFile, string xmlFileCustom, ToolStripRenderer tsRenderer = null)
		{
			...
			Size imageScalingSize = Catkeys.Util.Dpi.SmallIconSize; //if high DPI, auto scale images
