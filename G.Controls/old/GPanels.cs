...
namespace G.Controls
{
	...
	public sealed partial class GPanels
	{
		...
		public GPanels(Control dockHost)
		{
			...
			MultiPanels = new List<GPanel.MultiGPanel>();
		}
		...
		/// <summary>
		/// All MultiGPanel controls.
		/// </summary>
		internal List<GPanel.MultiGPanel> MultiPanels { get; private set; }
